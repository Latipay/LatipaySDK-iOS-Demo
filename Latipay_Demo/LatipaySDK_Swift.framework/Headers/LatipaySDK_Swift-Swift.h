...
#import <LatipaySDK_Swift/LatipaySDK_Swift.h>
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="LatipaySDK_Swift",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface LatipaySDK (SWIFT_EXTENSION(LatipaySDK_Swift)) <WXApiDelegate>
...
@interface LatipaySDK (SWIFT_EXTENSION(LatipaySDK_Swift))
+ (void)setupWithApiKey:(NSString * _Nonnull)apiKey userId:(NSString * _Nonnull)userId walletId:(NSString * _Nonnull)walletId wechatAppId:(NSString * _Nonnull)wechatAppId;
...
@interface PayResp (SWIFT_EXTENSION(LatipaySDK_Swift))
